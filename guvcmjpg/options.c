...
static opt_values_t opt_values[] =
{
    ...
    {
		.opt_short = 'q',
		.opt_long = "cmos_camera",
		.req_arg = 1,
		.opt_help_arg = N_("CAMERA"),
		.opt_help = N_("Set CMOS camera use (def: 1)")
	},
	{
		.opt_short = 'd',
		.opt_long = "device",
...
static options_t my_options =
{
    ...
    .cmos_camera = 1,   /* use CMOS CAMERA - default */
	.capture = "",
	.video_codec = "",
	.audio_codec = "",
	.prof_filename = NULL,
	...
	*opt_str_ptr++='\0'; /*null terminated string*/
		...
		long_options, &long_index )) != -1)
	{
		switch (opt)
		{
            ...
            case 'q':
				my_options.cmos_camera = atoi(optarg);
				break;
